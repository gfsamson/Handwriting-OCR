...
#im_th = cv2.adaptiveThreshold(im_gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV,51,10)
...
for rect in rects:
    ...
    # Draw the rectangles
        ...
        #print('rect[1]: {}'.format(rect[1]))
        #print('rect[2]: {}'.format(rect[2]))
        #print('rect[3]: {}'.format(rect[3]))
